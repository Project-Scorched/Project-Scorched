		...
		soundGetIn[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_ext_getout","db+5",1,9};
		soundGetOut[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_int_getout","db+8",1,25};
		soundDammage[] = {"","db-5",1};
		soundEngineOnInt[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_int_start","db+3",1.0};
		soundEngineOnExt[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_ext_start","db+3",1.0,200};
		soundEngineOffInt[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_int_stop","db+3",1.0};
		soundEngineOffExt[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_ext_stop","db+3",1.0,200};
		...
		class Sounds
		{
			class Idle_ext
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_ext_rpm0","db-13",1,150};
			...
			class Engine
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_ext_rpm1","db-11",1,200};
			...
			class Engine1_ext
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_ext_rpm1","db-9",1,240};
			...
			class Engine2_ext
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_ext_rpm2","db-8",1,280};
			...
			class Engine3_ext
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_ext_rpm2","db-7",1,320};
			...
			class Engine4_ext
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_ext_rpm2","db-6",1,360};
			...
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_ext_low1_exhaust","db-4",1,280};
				frequency = "0.8 + ((rpm/2100) factor[(1300/2100),(3100/2100)])*0.2";
			...
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_ext_high1_exhaust","db-3",1,320};
				frequency = "0.8 + ((rpm/2100) factor[(2200/2100),(4100/2100)])*0.2";
			...
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_ext_high1_exhaust","db-2",1,360};
				frequency = "0.8 + ((rpm/2100) factor[(3300/2100),(4900/2100)])*0.2";
			...
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_ext_high1_exhaust","db0",1,400};
			...
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_ext_high1_exhaust","db2",1,450};
			...
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_int_low1_exhaust","db-9",1};
				frequency = "0.8 + ((rpm/2100) factor[(900/2100),(2100/2100)])*0.2";
			...
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_int_low1_exhaust","db-8",1};
				frequency = "0.8 + ((rpm/2100) factor[(1300/2100),(3100/2100)])*0.2";
			...
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_int_high1_exhaust","db-7",1};
				frequency = "0.8 + ((rpm/2100) factor[(2200/2100),(4100/2100)])*0.2";
			...
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_int_high1_exhaust","db-6",1};
				frequency = "0.8 + ((rpm/2100) factor[(3300/2100),(4900/2100)])*0.2";
			...
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_int_high1_exhaust","db-5",1};
				frequency = "0.8 + ((rpm/2100) factor[(4200/2100),(6200/2100)])*0.3";
			...
			{
				sound[] = {"psc_vehicles_g\hmmwv\HMMWV_sound\hmmwv_engine_int_high1_exhaust","db-4",1};
				frequency = "0.9 + ((rpm/2100) factor[(5100/2100),(6900/2100)])*0.2";
