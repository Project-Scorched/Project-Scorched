...
class CfgVehicles
{
	...
	class S_APC: O_APC_Wheeled_02_rcws_v2_F
	{
		#include "physx.hpp"
		author = "S";
		mapSize = 9.74;
		...
		accuracy = 0.25;
		displayName = "M115 Centaur";
		model = "\S_APC\model\S_apc.p3d";
		...
		hiddenSelectionsTextures[] = {"s_apc\textures\green\origin\additionally_co.paa","s_apc\textures\green\origin\base_co.paa","s_apc\textures\green\origin\detail_co.paa","s_apc\textures\green\origin\inside_crate_co.paa"};
...
*/
			...
			class Gun_left: NewTurret
			{
				...
				soundServo[] = {"S_APC\sound\turret_turn_manual",4,1,30};
				soundServoVertical[] = {"S_APC\sound\turret_turn_manual",4,1,30};
...
limitsArrayBottom[] = {{-26.4176, -44.9979}, {-25.8496, -14.6335}, {-19.6387, 14.7040}, {-0.1342, 37.8988}};
		...
		{
			tex[] = {};
			mat[] = {"S_APC\mat\additionally.rvmat","S_APC\mat\dam\additionally_dam.rvmat","S_APC\mat\dam\additionally_d.rvmat","S_APC\mat\base.rvmat","S_APC\mat\dam\base_dam.rvmat","S_APC\mat\dam\base_d.rvmat","S_APC\mat\detail.rvmat","S_APC\mat\dam\detail_dam.rvmat","S_APC\mat\dam\detail_d.rvmat","S_APC\mat\inside_crate.rvmat","S_APC\mat\dam\inside_crate_dam.rvmat","S_APC\mat\dam\inside_crate_d.rvmat"};
		};
...
displayNameDefault = "<img image='\A3\Ui_f\data\IGUI\Cfg\Actions\open_door_ca.paa' size='2.5' />";
		...
		class TextureSources
		{
			class Green
			{
				displayName = "Green";
				author = "S";
				textures[] = {"s_apc\textures\green\origin\additionally_co.paa","s_apc\textures\green\origin\base_co.paa","s_apc\textures\green\origin\detail_co.paa","s_apc\textures\green\origin\inside_crate_co.paa"};
				//factions[] = {"OPF_F"};
			};
			class GreenStar
			{
				...
				author = "S";
				textures[] = {"s_apc\textures\green\Star\additionally_co.paa","s_apc\textures\green\origin\base_co.paa","s_apc\textures\green\origin\detail_co.paa","s_apc\textures\green\origin\inside_crate_co.paa"};
				//factions[] = {"OPF_F"};
			};
			class Black
			{
				displayName = "Black";
				author = "S";
				textures[] = {"s_apc\textures\Black\origin\additionally_co.paa","s_apc\textures\Black\origin\base_co.paa","s_apc\textures\Black\origin\detail_co.paa","s_apc\textures\Black\origin\inside_crate_co.paa"};
				//factions[] = {"OPF_F"};
			};
			class BlackStar
			{
				...
				author = "S";
				textures[] = {"s_apc\textures\Black\Star\additionally_co.paa","s_apc\textures\Black\origin\base_co.paa","s_apc\textures\Black\origin\detail_co.paa","s_apc\textures\Black\origin\inside_crate_co.paa"};
				//factions[] = {"OPF_F"};
			};
			class Blue
			{
				displayName = "Blue";
				author = "S";
				textures[] = {"s_apc\textures\Blue\origin\additionally_co.paa","s_apc\textures\Blue\origin\base_co.paa","s_apc\textures\Blue\origin\detail_co.paa","s_apc\textures\Blue\origin\inside_crate_co.paa"};
				//factions[] = {"OPF_F"};
			};
			class BlueStar
			{
				...
				author = "S";
				textures[] = {"s_apc\textures\Blue\Star\additionally_co.paa","s_apc\textures\Blue\origin\base_co.paa","s_apc\textures\Blue\origin\detail_co.paa","s_apc\textures\Blue\origin\inside_crate_co.paa"};
				//factions[] = {"OPF_F"};
			};
			class brown
			{
				displayName = "Brown";
				author = "S";
				textures[] = {"s_apc\textures\brown\origin\additionally_co.paa","s_apc\textures\brown\origin\base_co.paa","s_apc\textures\brown\origin\detail_co.paa","s_apc\textures\brown\origin\inside_crate_co.paa"};
				//factions[] = {"OPF_F"};
			};
			class brownStar
			{
				...
				author = "S";
				textures[] = {"s_apc\textures\brown\Star\additionally_co.paa","s_apc\textures\brown\origin\base_co.paa","s_apc\textures\brown\origin\detail_co.paa","s_apc\textures\brown\origin\inside_crate_co.paa"};
				//factions[] = {"OPF_F"};
			};
			class Grey
			{
				displayName = "Grey";
				author = "S";
				textures[] = {"s_apc\textures\Grey\origin\additionally_co.paa","s_apc\textures\Grey\origin\base_co.paa","s_apc\textures\Grey\origin\detail_co.paa","s_apc\textures\Grey\origin\inside_crate_co.paa"};
				//factions[] = {"OPF_F"};
			};
			class GreyStar
			{
				...
				author = "S";
				textures[] = {"s_apc\textures\Grey\Star\additionally_co.paa","s_apc\textures\Grey\origin\base_co.paa","s_apc\textures\Grey\origin\detail_co.paa","s_apc\textures\Grey\origin\inside_crate_co.paa"};
				//factions[] = {"OPF_F"};
			};
			class White
			{
				displayName = "White";
				author = "S";
				textures[] = {"s_apc\textures\White\origin\additionally_co.paa","s_apc\textures\White\origin\base_co.paa","s_apc\textures\White\origin\detail_co.paa","s_apc\textures\White\origin\inside_crate_co.paa"};
				//factions[] = {"OPF_F"};
			};
			class WhiteStar
			{
				...
				author = "S";
				textures[] = {"s_apc\textures\White\Star\additionally_co.paa","s_apc\textures\White\origin\base_co.paa","s_apc\textures\White\origin\detail_co.paa","s_apc\textures\White\origin\inside_crate_co.paa"};
				//factions[] = {"OPF_F"};
			};
		};
