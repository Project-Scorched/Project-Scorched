...
private _laserStartPosition = getPosASL _projectile;  //Gets laser start position
...
drawLine3D [ASLToAGL _laserStartPosition, ASLToAGL _laserEndPosition, [255, 0, 0, 1], 150];
