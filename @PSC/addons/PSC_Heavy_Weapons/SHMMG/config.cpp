...
class WeaponSlotsInfo {
		...
		class Single: Mode_SemiAuto {
			...
			autofire = 0;
            begin1[] = {"PSC_Shoulder_MG\sound\UMPfiring1.wav", 1.0, 1, 1200};
            begin2[] = {"PSC_Shoulder_MG\sound\UMPfiring2.wav", 1.0, 1, 1200};
			burst = 1;
			canshootinwater = 0;
	...
	class PSC_Shoulder_MG : PSC_Shoulder_MG_base {
		scope = 2;
	};
};
...
class CfgMagazines {
	...
	class tb_30Rnd_556x45_B_Stanag : 30Rnd_556x45_Stanag {
		...
		initspeed = 930;
		lastroundstracer = 0;
		picture = "\PSC_Shoulder_MG\UI\gear_hkump45_mag_ca";
		model = "PSC_Shoulder_MG\hkump_mag";
		scope = 2;
		tracersevery = 0;
	};
